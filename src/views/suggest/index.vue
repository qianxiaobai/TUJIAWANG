    ...
    <div class="customer-feedback">
      ...
      <div class="textarea">
        <textarea
          ...
          id="comment"
          maxlength="3900"
          placeholder="亲爱的途途，您在使用过程中遇到了什么问题？"
          v-model="magtext"
        ></textarea>
      </div>
      <div class="input">
        <input
          ...
          type="text"
          maxlength="50"
          placeholder="留下您的联系方式，方便我们后续联系您。"
          v-model="msg"
          data-oldvalue
        />
      </div>
      <v-touch
        ...
        tap="div"
        @tap="handlerSubmit()"
        :class="color?'btn-send1':'btn-send'"
        class="btn-send"
        data-time="1565342102843"
      >提交反馈</v-touch>
    </div>
...
.customer-feedback textarea {
  ...
  resize: none;
  font-size: 400 14px/1.5 Arial, "Lucida Grande", Verdana, "Microsoft YaHei",
    hei;
  outline: medium;
}
